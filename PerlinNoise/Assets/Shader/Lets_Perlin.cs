...
public class Lets_Perlin : MonoBehaviour {
    ...
    private PerlinScript.PerlinNoise _noise;
    private PerlinScript.PerlinNoise Noise
    {
        get
        {
            if(_noise == null)
            {
                _noise = new PerlinScript.PerlinNoise(_seed);
            }
            return _noise;
        }
    }
